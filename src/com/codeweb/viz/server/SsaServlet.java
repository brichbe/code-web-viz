...
public class SsaServlet extends HttpServlet
{
      ...
      ProjectPackage parentPkg) throws JSONException
  {
    ...
    for (ProjectSrcFile srcFile : srcFiles)
    {
      ...
      srcNode.put("title", "Class: <b>" + filename + "</b><br>SLOC: <b>" + srcFile.getSlocCount() + "</b>");
  ...
  {
    ProjectStructure project = FileIO.read(new File(getServletContext().getRealPath(
        "data/ssa/CodeWeb_SSA_2016-02-06 21-31-51.ssa")));
